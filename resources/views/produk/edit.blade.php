            ...
            <form action="{{ route('produk.update', $produk->ProdukID) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('NamaProduk') is-invalid @enderror" 
                            id="NamaProduk" name="NamaProduk" value="{{ old('NamaProduk', $produk->NamaProduk) }}" required>
                        @error('NamaProduk')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('Harga') is-invalid @enderror" 
                                id="Harga" name="Harga" value="{{ old('Harga', $produk->Harga) }}" step="0.01" min="0" required>
                        </div>
                        @error('Harga')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    @if($produk->Gambar)
                        <div class="mt-2">
                            <p>Gambar Saat Ini:</p>
                            <img src="{{ asset('storage/produk/'.$produk->Gambar) }}" alt="{{ $produk->NamaProduk }}" 
